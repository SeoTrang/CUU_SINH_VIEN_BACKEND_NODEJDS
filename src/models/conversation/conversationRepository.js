...
const conversationRepository = {
    ...
    getAllConversationFromUser: async(user_id) => {
        try {
            ...
            WHERE
                user_conversations.user_id = ${user_id} and user_conversations.status = 'accept' and conversations.status = 'accept'
            GROUP BY
    ...
    deletePrivateChat: async (conversation_id) => {
        try{
            ...
            if(!conversation.type == 'user') throw new Error('can not delete room conversation')
