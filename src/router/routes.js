...
router.delete('/conversation/delete-private-chat/:conversation_id',checkLogin,conversationController.deletePrivateConversation);
...
router.delete('/conversation/delete-user',checkLogin,conversationController.deleteUserOutGroup);
...
// -----------------------------------create school + faculty + group when don't have it---------------------------------
router.post('/conversation/create-group-conversation-school-faculty-group',checkLogin,conversationController.createGroupConversationSchoolFaculty);
...
router.delete('/user-v1',userController.deleteUser)

router.delete('/user-v2',userController.deleteUserV2)
